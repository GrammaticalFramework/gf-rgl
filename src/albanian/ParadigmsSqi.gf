...
oper
  ...
  reg2N : Str -> Str -> N   -- s;Indef;Nom;Sg  s;Indef;Nom;Pl
    = \form1, form2 -> case <form1, form2> of {
		...
		<_ + "ozë", _ + "ra"> => mkN168 form1;
		<_ + "ill", _ + "ë"> => mkN007 form1;
		<_ + "ill", _ + "j"> => mkN176 form1;
		...
		<_ + "ese", _ + "a"> => mkN309 form1;
		<_ + "lon", _ + "a"> => mkN012 form1;
		<_ + "ërç", _ + "i"> => mkN494 form1;
		<_ + "jer", _ + "a"> => mkN013 form1;
		<_ + "ngj", _ + "r"> => mkN273 form1;
		...
		<_ + "bel", _ + "e"> => mkN413 form1;
		<_ + "oll", _ + "j"> => mkN176 form1;
		<_ + "gsh", _ + "a"> => mkN057 form1;
		<_ + "nor", _ + "a"> => mkN079 form1;
		<_ + "hap", _ + "ë"> => mkN034 form1;
		<_ + "tur", _ + "a"> => mkN136 form1;
		<_ + "dhe", _ + "a"> => mkN107 form1;
		<_ + "dhe", _ + "j"> => mkN243 form1;
		<_ + "mam", _ + "ë"> => mkN031 form1;
		<_ + "let", _ + "ë"> => mkN031 form1;
		<_ + "zan", _ + "a"> => mkN271 form1;
		<_ + "ban", _ + "e"> => mkN075 form1;
		<_ + "ban", _ + "i"> => mkN332 form1;
		<_ + "cak", _ + "ë"> => mkN034 form1;
		<_ + "cak", _ + "e"> => mkN104 form1;
		<_ + "rbe", _ + "e"> => mkN080 form1;
		<_ + "ace", _ + "e"> => mkN063 form1;
		<_ + "ebe", _ + "e"> => mkN201 form1;
		...
		<_ + "pik", _ + "a"> => mkN276 form1;
		<_ + "tik", _ + "ë"> => mkN041 form1;
		<_ + "ing", _ + "a"> => mkN276 form1;
		<_ + "ami", _ + "i"> => mkN059 form1;
		<_ + "omi", _ + "i"> => mkN059 form1;
		<_ + "omi", _ + "a"> => mkN156 form1;
		<_ + "lli", _ + "j"> => mkN243 form1;
		<_ + "lig", _ + "e"> => mkN245 form1;
		<_ + "gje", _ + "j"> => mkN115 form1;
		<_ + "për", _ + "j"> => mkN207 form1;
		<_ + "epë", _ + "a"> => mkN073 form1;
		<_ + "ikë", _ + "a"> => mkN073 form1;
		<_ + "rrë", _ + "ë"> => mkN146 form1;
		<_ + "rrë", _ + "e"> => mkN221 form1;
		<_ + "irë", _ + "ë"> => mkN162 form1;
		<_ + "orë", _ + "ë"> => mkN146 form1;
		<_ + "apë", _ + "ë"> => mkN148 form1;
		<_ + "ajë", _ + "e"> => mkN132 form1;
		<_ + "ajë", _ + "ë"> => mkN146 form1;
		<_ + "ilë", _ + "a"> => mkN073 form1;
		<_ + "htë", _ + "e"> => mkN132 form1;
		<_ + "htë", _ + "ë"> => mkN177 form1;
		<_ + "zmë", _ + "ë"> => mkN146 form1;
		<_ + "itë", _ + "ë"> => mkN146 form1;
		<_ + "itë", _ + "e"> => mkN351 form1;
		<_ + "ugë", _ + "ë"> => mkN146 form1;
		<_ + "mbë", _ + "a"> => mkN073 form1;
		<_ + "rsi", _ + "i"> => mkN106 form1;
		<_ + "ran", _ + "j"> => mkN241 form1;
		<_ + "rnë", _ + "ë"> => mkN174 form1;
		<_ + "rzë", _ + "ë"> => mkN174 form1;
		<_ + "ogë", _ + "ë"> => mkN149 form1;
		<_ + "ogë", _ + "e"> => mkN360 form1;
		<_ + "umë", _ + "ë"> => mkN162 form1;
		<_ + "rgë", _ + "ë"> => mkN146 form1;
		<_ + "oni", _ + "i"> => mkN237 form1;
		<_ + "api", _ + "j"> => mkN235 form1;
		<_ + "lpë", _ + "a"> => mkN190 form1;
		...
		<_ + "hë", _ + "iha"> => mkN073 form1;
		<_ + "hë", _ + "oha"> => mkN073 form1;
		<_ + "hë", _ + "tha"> => mkN073 form1;
		<_ + "hë", _ + "xhë"> => mkN244 form1;
		<_ + "kë", _ + "uka"> => mkN073 form1;
		<_ + "kë", _ + "oka"> => mkN073 form1;
		<_ + "kë", _ + "ska"> => mkN073 form1;
		<_ + "kë", _ + "jka"> => mkN073 form1;
		<_ + "kë", _ + "pka"> => mkN073 form1;
		<_ + "kë", _ + "tka"> => mkN073 form1;
		<_ + "kë", _ + "ekë"> => mkN174 form1;
		<_ + "kë", _ + "akë"> => mkN200 form1;
		<_ + "kë", _ + "skë"> => mkN270 form1;
		<_ + "lë", _ + "ala"> => mkN073 form1;
		<_ + "lë", _ + "rla"> => mkN073 form1;
		<_ + "lë", _ + "ele"> => mkN221 form1;
		<_ + "cë", _ + "nca"> => mkN073 form1;
		<_ + "cë", _ + "rca"> => mkN073 form1;
		<_ + "cë", _ + "mca"> => mkN073 form1;
		<_ + "cë", _ + "eca"> => mkN073 form1;
		<_ + "bë", _ + "aba"> => mkN073 form1;
		<_ + "bë", _ + "rba"> => mkN073 form1;
		<_ + "je", _ + "hja"> => mkN309 form1;
		<_ + "en", _ + "je"> => mkN030 form1;
		<_ + "ht", _ + "ra"> => mkN082 form1;
		<_ + "sh", _ + "ra"> => mkN090 form1;
		<_ + "le", _ + "ja"> => mkN155 form1;
		<_ + "ym", _ + "ra"> => mkN082 form1;
		<_ + "hë", _ + "ra"> => mkN183 form1;
		...
		<_ + "l", _ + "oje"> => mkN250 form1;
		<_ + "l", _ + "yej"> => mkN206 form1;
		<_ + "l", _ + "gaj"> => mkN058 form1;
		<_ + "l", _ + "jaj"> => mkN176 form1;
		<_ + "l", _ + "huj"> => mkN206 form1;
		<_ + "l", _ + "fuj"> => mkN206 form1;
		<_ + "l", _ + "zuj"> => mkN206 form1;
		<_ + "l", _ + "këj"> => mkN206 form1;
		<_ + "m", _ + "ema"> => mkN013 form1;
		<_ + "m", _ + "rmë"> => mkN108 form1;
		<_ + "n", _ + "ane"> => mkN075 form1;
		<_ + "ë", _ + "amë"> => mkN162 form1;
		<_ + "ë", _ + "etë"> => mkN148 form1;
		<_ + "ë", _ + "anë"> => mkN148 form1;
		<_ + "ë", _ + "ijë"> => mkN244 form1;
		<_ + "ë", _ + "ngë"> => mkN200 form1;
		<_ + "ë", _ + "isë"> => mkN174 form1;
		<_ + "ë", _ + "arë"> => mkN149 form1;
		<_ + "ë", _ + "ërë"> => mkN149 form1;
		<_ + "ë", _ + "éza"> => mkN443 form1;
		<_ + "t", _ + "je"> => mkN030 form1;
		<_ + "t", _ + "ra"> => mkN082 form1;
		<_ + "l", _ + "je"> => mkN006 form1;
		<_ + "l", _ + "ra"> => mkN082 form1;
		<_ + "j", _ + "ra"> => mkN090 form1;
		<_ + "e", _ + "ré"> => mkN306 form1;
		<_ + "e", _ + "ja"> => mkN155 form1;
		<_ + "e", _ + "ra"> => mkN362 form1;
		<_ + "ë", _ + "ëë"> => mkN031 form1;
		<_ + "ë", _ + "gë"> => mkN148 form1;
		<_ + "ë", _ + "rë"> => mkN174 form1;
		<_ + "h", _ + "a"> => mkN013 form1;
		<_ + "h", _ + "h"> => mkN071 form1;
		...
		<_ + "d", _ + "d"> => mkN177 form1;
		<_ + "d", _ + "r"> => mkN273 form1;
		<_ + "r", _ + "e"> => mkN002 form1;
		<_ + "r", _ + "a"> => mkN013 form1;
		<_ + "r", _ + "i"> => mkN263 form1;
		...
		<_ + "s", _ + "ë"> => mkN031 form1;
		<_ + "s", _ + "i"> => mkN332 form1;
		...
		<_ + "q", _ + "r"> => mkN273 form1;
		<_ + "z", _ + "e"> => mkN002 form1;
		<_ + "z", _ + "z"> => mkN177 form1;
		...
		<_ + "g", _ + "j"> => mkN087 form1;
		<_ + "f", _ + "a"> => mkN013 form1;
		<_ + "ë", _ + "ë"> => mkN146 form1;
		<_ + "ë", _ + "e"> => mkN221 form1;
