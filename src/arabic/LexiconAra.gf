...
--  lose_V2      = dirV2 (v1 "خسر" i a) ; --Dayyac, >aDAc
  ...
  music_N      = mkN "مُوسِيقَى" "مُوسِيقَى" Fem NoHum ; --no plur
...
--  paint_V2A    = mkV2A (v1 "دهن" a a ) [] ;
  ...
  planet_N     = mkN "كَوكَب" "كَواكِب" Masc NoHum ; -- quadriconsonantal
  plastic_N    = mkFullN (sndf "بلاستِيك") Masc NoHum ;
...
--  play_V2      = dirV2 (v1 "لعب" i a) ;
  ...
  radio_N      = mkFullN (sndf "راديُو") Masc NoHum ;
...
--  seek_V2      = dirV2 (v1 "طلب" a u) ;
  ...
  television_N = mkFullN (sndf "تِلِفِزيُون") Masc NoHum ;
...
--  understand_V2 = dirV2 (v1 "فهم" i a ) ;
  ...
  water_N      = mkN "ماء" "مِياه" Fem NoHum ; --"موه" "فاء" "فِياع" ??
  white_A      = clrA "بيض" ;
...
--  win_V2       = dirV2 (v1 "ربح" i a) ;
  woman_N      = mkN "إِمرَأَة" "نِسوَة" Fem Hum ;
