...
oper
  add_eo : Str -> Str = \stem ->
    case stem of {
      ...
      start + ult@#i
          => start + replaceVowel ult "여" ;
      start + ult@#o
          => start + replaceVowel ult "와" ;
      start + ult@#u
          => start + replaceVowel ult "워" ;

      -- Special case: monosyllabic stem
             -- 으 is dropped, replace the old vowel.
      #eu => replaceVowel stem "어" ;
             -- Otherwise add 어.
      x@? => stem + "어" ;

      -- Special cases with 으:
      -- 으 is dropped, the second vowel from the right becomes
      -- the new final vowel and then ㅏ or ㅓ comes accordingly.
      start + penult@? + ult@'contains_으'
         => let lastVow : Str = getVowel penult ;
                lastSyl : Str = replaceVowel ult lastVow ;
            in start + penult + case lastSyl of {
                      #a|#eo => lastSyl ;
                      #i => replaceVowel lastSyl "여" ;
                      #o => replaceVowel lastSyl "와" ;
                      #u => replaceVowel lastSyl "워" ;
                      #a_o => lastSyl + "아" ;
                      _    => lastSyl + "어"
                    } ;
  ...
  replaceVowel : (syl, vow : Str) -> Str = \syl,vow -> syl ;
  getVowel : Str -> Str = \s -> s ;
