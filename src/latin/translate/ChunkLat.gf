...
concrete ChunkLat of Chunk = CatLat, SymbolLat [Symb], ExtensionsLat [VPS,VPI] ** 
  ChunkFunctor - [Det_Chunk]
    with (Syntax = SyntaxLat), (Extensions = ExtensionsLat) **
  -- open 
  --   SyntaxLat, (E = ExtensionsLat), Prelude, 
  -- (R = ResLat), (P = ParadigmsLat) in
  {
