...
lin fly_V = mkV "repül" ;
lin fog_N = mkN "köd" ; -- TODO ködöket
...
lin night_N = mkN "éjszaka" ; --also shortened to "éj" ("este" more for evening)
...
lin silver_N = mkN "ezüst" ; -- TODO fix: ezüstöket
-- lin sing_V = mkV "" ;
-- lin sister_N = mkN "" ;
-- lin sit_V = mkV "" ;
lin skin_N = mkN "bőr" ;
...
lin song_N = mkN "dal" ; -- TODO fix: dalokat
-- lin speak_V2 = mkV2 "" ;
-- lin spit_V = mkV "" ;
-- lin split_V2 = mkV2 "" ;
-- lin squeeze_V2 = mkV2 "" ;
