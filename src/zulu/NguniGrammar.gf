...
abstract NguniGrammar =
  Noun [DetCN, UsePron, AdvNP, DetQuant, NumSg, NumPl, IndefArt, DefArt, UseN, AdjCN, RelCN, AdvCN, PossNP,PredetNP,UsePN], -- MassNP,
  ...
  Text - [Temp,Adv,IAdv],
  Structural [and_Conj,how_IAdv,how8much_IAdv,i_Pron,youSg_Pron,he_Pron,she_Pron,we_Pron,youPl_Pron,this_Quant,that_Quant,all_Predet,only_Predet],
  -- Idiom,
  Tense [PPos, PNeg],
  -- Transfer ,
